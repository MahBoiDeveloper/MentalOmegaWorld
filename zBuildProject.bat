...
copy Source\mapselmo.ini  Build\Resources\MOW\mapselmo.ini  > nul
echo Copy missionmo.ini...
copy Source\missionmo.ini Build\Resources\MOW\missionmo.ini > nul

echo Copy translated files...
...
copy Source\BattleClient.ini     Build\Resources\MOW\BattleClient.ini     > nul
